...
const Header4 = () => {
  return (
    <div className="mobile-notify flex justify-between items-center my-14 border-2 rounded-lg border-gray-300 px-5">
      <div className="flex items-center">
        <Image
          ...
          width={200}
          height={200}
          className="notify-img w-32 h-32 rounded-full mr-5"
        />
      ...
      <div className="mobile-email notify-email flex">
        <input
          type="notify-padding email"
