...
const Header3 = () => {
  ...
  return (
    <div className="banner bg-gradient-to-r from-pink-600 to-red-600 h-60">
      <div className=" p-5">
        <h2 className=" text-4xl text-white text-center font-bold">
          Over 157,000 hotels and homes across 35 countries
        </h2>
        <div className="mobile-header3 flex justify-center my-5 mx-20 ">
          <input
            type="text"
            placeholder="Search..."
          ...
          <button
            type="submit"
            className="mobile-search h-16 px-3 py-2 w-72 bg-green-400 hover:cursor-pointer hover:bg-green-600 text-white text-xl"
          >
